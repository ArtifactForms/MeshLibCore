 ...
 *
 * <p>
 * <b>Bug Summary:</b> The {@code BevelEdgesModifier} produced incorrect face
 ...
 *
 * <p>
 * <b>Purpose:</b> Ensure the {@code BevelEdgesModifier} correctly generates
 * pentagonal faces with the proper index order after the bug fix.
 * </p>
 *
 * <p>
 * <b>Reproduction Details:</b>
 * <ul>
 * <li>Create an icosphere using {@code IcosahedronCreator}.</li>
 * <li>Apply the {@code BevelEdgesModifier} with a small amount (e.g.,
 * 0.1).</li>
 * <li>Compare the indices of generated pentagonal faces with expected
 * values.</li>
 * </ul>
 * </p>
 *
 * <p>
 * <b>Expected Behavior:</b> The modifier produces pentagonal faces with index
 * order matching the predefined {@code expected} array.
 * </p>
 *
 * <p>
 * <b>Validation:</b> This test confirms that the revised {@code toReverseArray}
