 ...
 * <p>
 * Handles drawing the background, text, and decorative lines of the editor
 * menu, using styles defined in the Look and Feel (LAF) system.
 * </p>
 */
public class EditorMenuRenderer implements Renderer {
	...
	public void render(Graphics g, UiElement element) {
		if (!(element instanceof UiEditorMenu))
			return;
