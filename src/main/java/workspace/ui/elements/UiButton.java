 ...
 * <p>
 * A button can display text and execute an associated action when clicked.
 * Rendering is handled by a dedicated renderer, allowing for customizable
 * visual styles.
 * </p>
 */
public class UiButton extends UiComponent {
	 ...
	 * <p>
	 * If the button has an associated action listener, its
	 * {@link IActionListener#onActionPerformed()} method is invoked.
	 * </p>
	 *
