...
public class WorkspaceSideBarUi extends UiComponent implements ModelListener {
  ...
  protected UiCheckBox getGridCheckBox() {
    if (gridCheckBox != null) return gridCheckBox;
    ...
    gridCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getFaceNormalsCheckBox() {
    if (faceNormalsCheckBox != null) return faceNormalsCheckBox;
    ...
    faceNormalsCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getVertexNormalsCheckBox() {
    if (vertexNormalsCheckBox != null) return vertexNormalsCheckBox;
    ...
    vertexNormalsCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getWireFrameCheckBox() {
    if (wireFrameCheckBox != null) return wireFrameCheckBox;
    ...
    wireFrameCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getXAxisCheckBox() {
    if (xAxisCheckBox != null) return xAxisCheckBox;
    ...
    xAxisCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getYAxisCheckBox() {
    if (yAxisCheckBox != null) return yAxisCheckBox;
    ...
    yAxisCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getZAxisCheckBox() {
    if (zAxisCheckBox != null) return zAxisCheckBox;
    ...
    zAxisCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getEdgeCheckBox() {
    if (edgeCheckBox != null) return edgeCheckBox;
    ...
    edgeCheckBox.setActionListener(
        new IActionListener() {
  ...
  protected UiCheckBox getSmoothShadingCheckBox() {
    if (smoothShadingCheckBox != null) return smoothShadingCheckBox;
    ...
    smoothShadingCheckBox.setActionListener(
        new IActionListener() {

          @Override
          public void onActionPerformed() {
            model.setShading(smoothShadingCheckBox.isSelected() ? Shading.SMOOTH : Shading.FLAT);
          }
        });
  ...
  protected UiCheckBox getLoopCheckBox() {
    if (loopCheckBox != null) return loopCheckBox;
    ...
    loopCheckBox.setActionListener(
        new IActionListener() {
