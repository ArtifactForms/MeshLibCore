...
public class WorkspaceModel {
  ...
  public void setPanningX(float panningX) {
    if (this.panningX == panningX) return;
  ...
  public void setPanningY(float panningY) {
    if (this.panningY == panningY) return;
  ...
  public void setRotationX(float rotationX) {
    if (this.rotationX == rotationX) return;
  ...
  public void setRotationY(float rotationY) {
    if (this.rotationY == rotationY) return;
  ...
  public void setRotationZ(float rotationZ) {
    if (this.rotationZ == rotationZ) return;
    this.rotationZ = rotationZ;
    fireChangeEvent();
  }

  public void setRotation(float rx, float ry, float rz) {
    if (rotationX == rx && rotationY == ry && rotationZ == rz) return;
    rotationX = rx;
    rotationY = ry;
    rotationZ = rz;
    fireChangeEvent();
  ...
  public void setMaxScale(float maxScale) {
    if (this.maxScale == maxScale) return;
  ...
  public void setxAxisVisible(boolean xAxisVisible) {
    if (this.xAxisVisible == xAxisVisible) return;
  ...
  public void setyAxisVisible(boolean yAxisVisible) {
    if (this.yAxisVisible == yAxisVisible) return;
  ...
  public void setzAxisVisible(boolean zAxisVisible) {
    if (this.zAxisVisible == zAxisVisible) return;
  ...
  public void setFaceNormalsVisible(boolean faceNormalsVisible) {
    if (this.faceNormalsVisible == faceNormalsVisible) return;
  ...
  public void setVertexNormalsVisible(boolean vertexNormalsVisible) {
    if (this.vertexNormalsVisible == vertexNormalsVisible) return;
  ...
  public void setEdgesVisible(boolean edgesVisible) {
    if (this.edgesVisible == edgesVisible) return;
  ...
  public void setUiVisible(boolean uiVisible) {
    if (this.uiVisible == uiVisible) return;
  ...
  public void setShading(Shading shading) {
    if (this.shading == shading) return;
  ...
  public void setBackground(Color background) {
    if (this.background.equals(background)) return;
  ...
  public void setUseKeyBindings(boolean useKeyBindings) {
    if (this.useKeyBindings == useKeyBindings) return;
