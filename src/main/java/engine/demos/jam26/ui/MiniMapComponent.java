...
public class MiniMapComponent extends AbstractComponent implements RenderableComponent {
  ...
  public MiniMapComponent(TileMap tileMap, Scene scene) {
  ...
  public void render(Graphics g) {
    ...
    int playerTileX = worldToTile(camPos.x);
    int playerTileY = worldToTile(camPos.z);
