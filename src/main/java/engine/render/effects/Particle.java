...
public class Particle {
	...
	/**
	 * Applies damping to simulate drag or resistance, slowing down the particle's
	 * motion over time.
	 */
	...
	/**
	 * Updates the particle's position, velocity, and applies damping effects over
	 * a given time step. Resets acceleration after each update to ensure isolated
	 * force application each frame.
	 * 
	...
	/**
	 * Checks if the particle is still alive (i.e., has not exceeded its
	 * lifetime).
	 * 
	 * @return {@code true} if the particle's elapsed time is less than its total
	 *         lifetime, otherwise {@code false}.
	 */
	...
	/**
	 * Gets the previous position of the particle. Useful for rendering trails or
	...
	/**
	 * Sets the particle's lifetime to a new value. This can extend or shorten how
	 * long the particle will exist.
	 * 
