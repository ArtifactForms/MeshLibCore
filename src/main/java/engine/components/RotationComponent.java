...
/**
 * A simple rotation component that rotates the owning SceneNode around a specified axis at a
 * constant angular speed.
 *
 * <p>Properties:
 *
 * <ul>
 *   <li><b>axis:</b> The axis around which the rotation occurs.
 *   <li><b>angularSpeed:</b> The speed of rotation in radians per second.
 * </ul>
 *
 * <p>The rotation is applied incrementally to the Transform component of the owning SceneNode
...
public class RotationComponent extends AbstractComponent {
  ...
  /**
   * Constructs a RotationComponent with default axis (0, 1, 0) and angular speed. Default settings
  ...
  public RotationComponent(Vector3f axis, float angularSpeed) {
    if (axis == null || axis.length() == 0) {
      throw new IllegalArgumentException("Rotation axis cannot be null or zero-length.");
    }
