...
/**
 * Represents a generic camera within a 3D scene. A camera defines the view and
 * projection settings necessary for rendering a 3D scene from a specific
 * perspective. This interface abstracts common properties and functionalities
 * that all camera types share, including transformation, view matrices,
 * projection matrices, and interaction with screen-space coordinates.
 * <p>
...
public interface Camera {
	 ...
	 * </p>
	 *
	 * @return The {@link Transform} representing the camera's position, rotation,
	 *         and scaling.
	 */
	 ...
	 */
	Ray3f createRay(float screenX, float screenY, int viewportWidth,
	    int viewportHeight);

	/**
	 * Converts 2D screen-space coordinates to their corresponding world-space
	 * coordinates.
	 * <p>
	 ...
	 */
	Vector3f unproject(Vector3f screenCoords, int viewportWidth,
	    int viewportHeight);
