 ...
 * <p>
 * The equation of the plane is represented as: <br>
 * <code>Ax + By + Cz + D = 0</code>, where:
 * <ul>
 * <li><code>(A, B, C)</code> is the normalized normal vector of the plane.</li>
 * <li><code>D</code> is the distance of the plane from the origin, along the
 * normal direction.</li>
 * </ul>
 * </p>
 */
public class Plane {
	...
	/**
	 * Constructs a plane with a default normal vector (0, 0, 0) and a distance of
	 * 0.
	 * <p>
	 * The resulting plane is uninitialized and must be configured using the
	 * {@link #set(float, float, float, float)} method.
	 * </p>
	 */
	public Plane() {
	 ...
	 * <code>Ax + By + Cz + D = 0</code>. The normal vector is automatically
	 ...
	 * <p>
	 * The signed distance is computed as: <br>
	 * <code>distance = dot(normal, point) + D</code>, where:
	 * <ul>
	 * <li><code>normal</code> is the plane's normal vector.</li>
	 * <li><code>point</code> is the 3D point to test.</li>
	 * <li><code>D</code> is the distance parameter of the plane.</li>
	 * </ul>
	 * </p>
	 *
	 * @param point the point to calculate the distance from.
	 * @return the signed distance from the point to the plane. A positive value
	 *         indicates the point is in the direction of the normal vector, and a
	 *         negative value indicates it is on the opposite side.
	 */
