...
public class Color {
    ...
    /**
     * Constructs a new instance of this color with r,g,b,a components set to
     * the values provided by color c.
     * 
    ...
    /**
     * Adds the components of a given color to those of this color creating a
     * new color object. Each component is added separately. If the provided
    ...
    /**
     * Adds the provided components to this color internally, and returns a
    ...
    /**
     * Subtracts the components of a given color from those of this color
     * creating a new color object. Each component is subtracted separately. If
     * the provided color is null, an exception is thrown.
     * 
    ...
    /**
     * Subtracts the values of a given color from those of this color storing
     * the result in the given color. Each component is subtracted separately.
     * If the provided color c is null, an exception is thrown. If the provided
     * result color is null, a new color is created.
     * 
     * @param color  the color to subtract from this color
     * @param result the color to store the result in
    ...
    /**
     * * Subtracts the given r,g,b,a components from those of this color
     * creating a new color object. Each component is subtracted separately.
     * 
    ...
    /**
     * Subtracts the provided components from this color internally, and returns
     * a handle to this color for easy chaining of calls.
     * 
     * @param r the red component to subtract
     * @param g the green component to subtract
     * @param b the blue component to subtract
    ...
    /**
     * Sets all components of this color to 0.0f internally, and returns a
     * handle to this color for easy chaining of calls.
     * 
     * @return this
     */
    ...
    /**
     * Returns the maximum color component value: Max(r,g,b). This method does
     * not consider the alpha component.
     * 
    ...
    /**
     * Returns the RGBA value representing the color. (Bits 24-31 are alpha,
