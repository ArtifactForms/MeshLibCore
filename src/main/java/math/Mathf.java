...
public class Mathf {
     ...
     * Special cases:
     * <ul>
     * <li>If the argument is NaN or less than zero, then the result is
     * NaN.</li>
     ...
     * For example:
     * <ul>
     * <li>nextPowerOfTwo(1) returns 2</li>
     * <li>nextPowerOfTwo(2) returns 2</li>
     * <li>nextPowerOfTwo(3) returns 4</li>
     * <li>nextPowerOfTwo(16) returns 16</li>
     * <li>nextPowerOfTwo(17) returns 32</li>
     * </ul>
     *
