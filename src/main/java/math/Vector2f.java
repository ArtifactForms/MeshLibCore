...
public class Vector2f {
   ...
   *
   * <p>Linear interpolation calculates a new vector that is a portion of the way between two given
   * vectors. The parameter `t` determines how far along this line the new vector will be.
   *
   * <p>Mathematically, the interpolation is calculated as follows: result = this + t * (other -
   * this)
   *
   * <p>Where: - `this` is the current vector - `other` is the target vector - `t` is the
   ...
   * rectangular coordinates ( <code>x</code>,&nbsp; <code>y</code>) to polar coordinates (r,&nbsp;
   * <i>theta</i>).
   *
