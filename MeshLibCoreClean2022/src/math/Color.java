...
public class Color {
	 ...
	 * 
	 * @param r
	 *            the red component for the color (0 to 255)
	 * @param g
	 *            the green component for the color (0 to 255)
	 * @param b
	 *            the blue component for the color (0 to 255)
	 * 
	 ...
	 * 
	 * @param r
	 *            the red component to add
	 * @param g
	 *            the green component to add
	 * @param b
	 *            the blue component to add
	 * @param a
	 *            the alpha component to add
	 * @return the resultant color
	 */
	 ...
	 * 
	 * @param r
	 *            the red component to subtract
	 * @param g
	 *            the green component to subtract
	 * @param b
	 *            the blue component to subtract
	 * @param a
	 *            the alpha component to subtract
	 * @return the resultant color
	 */
	 ...
	 * 
	 * @param store
	 *            the array to store the components into
	 * @return store
	 ...
	 * 
	 * @param r
	 *            the new red component for this color
	 * @param g
	 *            the new green component for this color
	 * @param b
	 *            the new blue component for this color
	 * @param a
	 *            the new alpha component for this color
	 */
