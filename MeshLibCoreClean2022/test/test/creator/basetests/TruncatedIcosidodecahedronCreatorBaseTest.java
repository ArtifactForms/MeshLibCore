...
public class TruncatedIcosidodecahedronCreatorBaseTest {
	...
	Mesh3D mesh0 = new TruncatedIcosidodecahedronCreator().create();
	Mesh3D mesh1 = new TruncatedIcosidodecahedronCreator().create();
