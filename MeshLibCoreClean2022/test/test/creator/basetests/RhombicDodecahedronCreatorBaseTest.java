...
public class RhombicDodecahedronCreatorBaseTest {

    private Mesh3D mesh;

    @Before
    public void setUp() {
        mesh = new RhombicDodecahedronCreator().create();
    }
    ...
    public void eachCallOfCreateReturnsNewUniqueMeshInstance() {
        Mesh3D mesh0 = new RhombicDodecahedronCreator().create();
        Mesh3D mesh1 = new RhombicDodecahedronCreator().create();
