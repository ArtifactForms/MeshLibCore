...
public class TruncatedIcosahedronCreatorBaseTest {
    ...
    public void eachCallOfCreateReturnsNewUniqueMeshInstance() {
        Mesh3D mesh0 = new TruncatedIcosahedronCreator().create();
        Mesh3D mesh1 = new TruncatedIcosahedronCreator().create();
