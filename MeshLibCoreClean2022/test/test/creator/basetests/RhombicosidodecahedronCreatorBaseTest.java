...
public class RhombicosidodecahedronCreatorBaseTest {
    ...
    public void eachCallOfCreateReturnsNewUniqueMeshInstance() {
        Mesh3D mesh0 = new RhombicosidodecahedronCreator().create();
        Mesh3D mesh1 = new RhombicosidodecahedronCreator().create();
