...
public class MucubeCreatorBaseTest {

    private Mesh3D mesh;

    @Before
    public void setUp() {
	mesh = new MucubeCreator().create();
    }
	...
	Mesh3D mesh0 = new MucubeCreator().create();
	Mesh3D mesh1 = new MucubeCreator().create();
