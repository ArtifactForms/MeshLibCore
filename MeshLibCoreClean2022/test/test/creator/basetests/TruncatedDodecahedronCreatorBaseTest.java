...
public class TruncatedDodecahedronCreatorBaseTest {
	...
	Mesh3D mesh0 = new TruncatedDodecahedronCreator().create();
	Mesh3D mesh1 = new TruncatedDodecahedronCreator().create();
