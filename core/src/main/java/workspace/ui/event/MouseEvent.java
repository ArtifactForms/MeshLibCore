 ...
 *
 * <p>This class is used to encapsulate the state of the mouse during an event, such as mouse
 * movement or mouse clicks. It provides details about the mouse's current coordinates as well as
