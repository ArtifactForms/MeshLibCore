 ...
 *
 * <p>This interface establishes a contract for rendering different types of light sources in a 3D
...
public interface LightRenderer {
   ...
   *
   * <p>This method initializes the rendering environment by associating the given {@link Graphics}
   ...
   *
   * <p>This method is a catch-all for rendering any light source that implements the {@link Light}
   ...
   * Renders a spotlight.
   *
   * <p>This method is responsible for rendering a spotlight with specific directionality, cone
   ...
   *
   * <p>This method handles the rendering of a point light, which emits light uniformly in all
   ...
   *
   * <p>This method handles rendering for a directional light, which simulates light coming from a
   ...
   *
   * <p>This method handles the rendering of ambient light, which provides uniform illumination
