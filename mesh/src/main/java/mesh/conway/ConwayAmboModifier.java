...
public class ConwayAmboModifier implements IMeshModifier {
  ...
  /**
   * For each vertex of the original mesh, connect the new points that have been generated for the
   * faces that are adjacent to this vertex.
   */
  ...
  private Vector3f calculateEdgePoint(int startVertexIndex, int endVertexIndex) {
    return calculateEdgePoint(
        getOriginalVertexAt(startVertexIndex), getOriginalVertexAt(endVertexIndex));
  }
