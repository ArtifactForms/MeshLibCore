 ...
 *
 * <p>The label supports customizable text, background, and foreground colors. Rendering logic is
 * delegated to a dedicated renderer for consistency with the framework's modular design.
 */
