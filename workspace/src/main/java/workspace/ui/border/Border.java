 ...
 *
 * <p>A `Border` defines how to visually render a boundary around a UI element and specifies the
 * spacing (insets) it requires.
 */
public interface Border {
   ...
   *
   * <p>Insets specify the spacing required between the border and the content of the UI element.
   * These insets are typically used in layout calculations.
   *
   * @return An {@link Insets} object representing the top, left, bottom, and right insets of the
   *     border.
   */
  Insets getInsets();
}
