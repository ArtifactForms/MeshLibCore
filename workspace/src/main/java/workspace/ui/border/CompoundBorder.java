...
/**
 * A border implementation that combines two borders: an outer border and an inner border. The outer
 * border is rendered first, followed by the inner border, which is adjusted to fit within the
 * insets of the outer border.
 */
public class CompoundBorder implements Border {
   ...
   *
   * @return An Insets object representing the total insets of the compound border.
   */
  @Override
  ...
  /**
   * Renders the outer border and adjusts the coordinates and dimensions to render the inner border
   ...
   * @param height The height of the area to render the border around.
   */
  private void renderOuterBorder(Graphics g, int x, int y, int width, int height) {
   ...
   * @param height The height of the area to render the border around.
   */
  private void renderInnerBorder(Graphics g, int x, int y, int width, int height) {
