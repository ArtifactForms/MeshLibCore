...
/**
 * Represents a 2D Insets model, typically used for defining spacing around UI elements (e.g.,
 * margins, padding, or borders).
 *
 * <p>Each side of the inset (top, left, bottom, right) can be configured independently or
 * uniformly. The class also provides utility methods for computing total horizontal and vertical
 * spacing, and supports operations like adding insets or copying values.
 */
public class Insets {
   ...
   * @return true if the other object is an Insets instance with identical values; false otherwise
   */
  @Override
  ...
  /**
   * Computes a hash code for this Insets object, consistent with the {@link #equals(Object)}
   * method.
   *
   ...
   *
   * @return a string describing the insets in the format: "Insets [top=..., left=..., bottom=...,
   *     right=...]"
   */
  @Override
