...
/**
 * A border implementation that draws a solid line around a UI element. The thickness and color of
 * the border can be customized.
 */
public class LineBorder implements Border {
  ...
  /**
   * Renders the border by drawing nested rectangles to achieve the desired thickness.
   *
  ...
  /**
   * Returns the insets required for this border, which are equal to the border thickness on all
   * sides.
   *
