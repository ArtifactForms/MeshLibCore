...
/**
 * Defines the different biomes in the game world.
 * Each biome has specific properties like top blocks, filler blocks,
 * tree spawn chances, and a base height for terrain generation.
 */
